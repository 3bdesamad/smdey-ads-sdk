...
import com.smdey.ads.sample.databinding.ActivityNormalBannerBinding;

public class NormalBannerActivity extends AppCompatActivity {

    private ActivityNormalBannerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityNormalBannerBinding.inflate(getLayoutInflater());
    ...
    private void initListeners() {
        binding.btnOpenSecondNormalBanner.setOnClickListener(v -> {
            startActivity(new Intent(NormalBannerActivity.this, SecondNormalBannerActivity.class));
        });
    }
    ...
    private void initToolbar() {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setTitle("Normal Banner Screen");
        }
